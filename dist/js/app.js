...
***************************************************************************** */
        ...
        da.init();
        var hc_sticky = __webpack_require__(817);
        ...
        if (templateInstructions) {
            ...
            if (instructionSearch) instructionSearch.addEventListener("input", (function() {
        ...
        function initSidebarSticky() {
            ...
            if (!el) return;
            updateDistanceСatalogToTop();
            const getTop = () => parseInt(getComputedStyle(document.body).getPropertyValue("--header-bottom-height")) + 16;
